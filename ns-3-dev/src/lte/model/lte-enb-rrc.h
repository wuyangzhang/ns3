...
public:
  ...
  void SetConnectionEstablishedCallback(Callback<void, uint64_t, uint16_t, uint16_t> callback);

  void SetHandoverJoiningTimeoutCallback(Callback<void, uint16_t> callback);

  void SetHandoverLeavingTimeoutCallback(Callback<void, uint16_t> callback);
...
private:
  ...
  Callback<void, uint64_t, uint16_t, uint16_t> m_connectionEstablishedCallback;

  Callback<void, uint16_t> m_handoverJoiningTimeoutCallback;

  Callback<void, uint16_t> m_handoverLeavingTimeoutCallback;
