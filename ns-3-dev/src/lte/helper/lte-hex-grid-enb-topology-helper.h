...
public:
  ...
  void SetDlEarfcnList(std::vector<uint32_t> earfcnList);

  void SetUlEarfcnList(std::vector<uint32_t> earfcnList);
...
private:
  ...
  /**
   * List of DL EARFCN numbers for each sector
   */
  std::vector<uint32_t> m_dlEarfcnList;

  /**
   * List of UL EARFCN numbers for each sector
   */
  std::vector<uint32_t> m_ulEarfcnList;
